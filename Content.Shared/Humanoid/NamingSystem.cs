    ...
    public sealed class NamingSystem : EntitySystem
    {
        ...
        public string GetName(string species, Gender? gender = null)
        {
            ...
            switch (speciesProto.Naming)
            {
                ...
                case SpeciesNaming.FirstDashLast: // starcup: MKC name scheme
                    return Loc.GetString("namepreset-firstdashlast", ("first", GetFirstName(speciesProto, gender)), ("last", GetLastName(speciesProto)));
